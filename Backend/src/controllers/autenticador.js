...
const cadastrarResponsavel = async (req, res) => {
  ...
  try {
    ...
    const [resultado] = await pool.query(
      'INSERT INTO usuarios (nome, email, senha_hash, perfil) VALUES (?, ?, ?, "responsavel")',
    ...
    console.error("Erro ao cadastrar responsável:", erro);
    return res.status(500).json({ mensagem: "Erro interno do servidor." });
  }
};

module.exports = { login, cadastrarResponsavel };
