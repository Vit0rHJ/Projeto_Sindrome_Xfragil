...
const { login, cadastrarResponsavel } = require("../controllers/autenticador"); // importa a funcao de login criada antes, saimos do routes e voltamos para o scrr para encontrar o controller
...
router.post('/cadastro-responsavel', cadastrarResponsavel);
