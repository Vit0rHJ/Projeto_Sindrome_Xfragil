...
router.get("/:id", autenticar, buscarPorId); // busca um paciente completo por id (preenche o formulario de edicao)
router.put("/:id", autenticar, editarPaciente); // RF08 - edita os dados cadastrais do paciente
router.patch(
  "/:id/foto",
  autenticar,
  upload.single("foto"),
